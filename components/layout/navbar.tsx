...
export default function MobileNav() {
    return (
        <div className="md:hidden">
            ...
            <div className="w-full bg-[#FAFAFA] px-4 pt-5 pb-3 z-40 sticky top-0">
                ...
                <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-3">
                        {/* Avatar */}
                        <div className="w-9 h-9 rounded-full bg-[#0E1F35] flex items-center justify-center overflow-hidden">
                            <User className="w-5 h-5 text-blue-200" strokeWidth={2} />
                        </div>
                        {/* Brand Name */}
                ...
                <div className="flex items-center gap-2.5 overflow-x-auto no-scrollbar pb-1 -mx-4 px-4 scroll-smooth">
                    ...
                    <button className="px-5 py-1.5 rounded-full bg-[#E8EAEE] text-[#4A5568] text-[13px] font-semibold whitespace-nowrap transition-transform active:scale-95 leading-tight relative">
                        Cir
                        <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#FAFAFA] to-transparent pointer-events-none rounded-r-full" />
                    </button>
                </div>
            </div>

            {/* Floating Action Button */}
            <button className="fixed bottom-[88px] right-5 w-14 h-14 bg-[#0066FF] hover:bg-blue-700 text-white rounded-full flex items-center justify-center shadow-[0_8px_20px_rgba(0,102,255,0.35)] transition-transform hover:scale-105 active:scale-95 z-50">
            ...
            {/* Hide scrollbar classes inline (could also be in globals.css) */}
            <style jsx global>{`
